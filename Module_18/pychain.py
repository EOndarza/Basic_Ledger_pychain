...
sender = st.text_input("input the sender information")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input("input the receiver information")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.text_input("Input the transaction amount")
